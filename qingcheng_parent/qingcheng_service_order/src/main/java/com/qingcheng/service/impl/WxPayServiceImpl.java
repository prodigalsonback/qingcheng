...
public class WxPayServiceImpl implements WxPayService {
    ...
    public Map createNative(String orderId, Integer money, String notifyUrl,String... attach) {
        ...
        try {
            ...
            //发送订单号到延迟队列
            rabbitTemplate.convertAndSend("","queue.ordercreate",orderId);//queue.order
    ...
    public void closeOrder(String orderId) {
        try {
            ...
            System.out.println("关闭微信订单状态："+map.get("return_code"));
            if(("FAIL").equals(map.get("return_code"))) {
                System.out.println("关闭微信订单失败原因：" +map.get("return_msg"));
            }
